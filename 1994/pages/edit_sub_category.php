...
if(isset($_GET['id']))
    ...
    if(isset($_GET['confirm']) and $_GET['confirm'] == 'no'){
      confirm_message("Delete This sub-category?","index.php?cpages=pages/edit_sub_category&id=".$gid."&confirm=yes","index.php?cpages=pages/edit_sub_category");
    }

    if(isset($_GET['confirm']) and $_GET['confirm'] == 'yes'){
      $delete_sub_category = @mysql_query("DELETE FROM sub_category WHERE id='".$gid."'") or die(mysql_error());
      header("Location: index.php?cpages=pages/edit_sub_category");
    }

    $select_category = @mysql_query("select * from sub_category") or die(mysql_error());
?><!--1-->
<div class="row">
...
<!--1-->
            <h3>Edit | Delete Sub-Category ( <?php echo @mysql_num_rows($select_category);?> )</h3>
            ...
            <tr>
                ...
                <td>
                <a href="index.php?cpages=pages/edit_sub_category_by_id&id='.$category['id'].'"><input type="image" src="../images/icn_edit.png" title="Edit"></a> &nbsp;&nbsp;
                <a href="index.php?cpages=pages/edit_sub_category&id='.$category['id'].'&confirm=no"><input type="image" src="../images/icn_trash.png" title="Delete"></a> &nbsp;&nbsp;
                </td>
            </tr>
              ';
            }
