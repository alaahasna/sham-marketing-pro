        ...
        <div class="container">
          ...
          <br />
            ...
            if($num_search == 0){
              ...
              echo 'Search Results ( '.$num_search.' )';
            }
            ?>
            </h2>
          </div>
            ...
            while($results = @mysql_fetch_assoc($select_search)){
              ...
              <div class="card">
                <a href="single.php?id='.$results['id'].'">
                  ...
                  <img class="activator" src="images/'.$results['pic'].'" alt="'.$results['title'].'" class="img-responsive">
                </div>
                <div class="card-content center-align">
                  <span class="card-title activator grey-text text-darken-4">'.mb_substr($results['title'],0,12,'UTF-8').'..</span>
                  <a href="single.php?id='.$results['id'].'" style="font-size: 9pt;" class="btn btn-float">View Product</a>
                </div>
                </a>
              </div>
            </div>
