...
if(!isset($_SESSION['US_id']) or !isset($_SESSION['US_test'])){
  ...
  if(filter_var($email, FILTER_VALIDATE_EMAIL)){
    ...
    error_message("حقل الاسم الأخير مطلوب!");
  }
  }else{
    error_message("حقل الاسم الأول مطلوب!");
  }
  }
...
?>
  ...
  <html>
    <head>
      ...
      <meta charset="utf-8">
      <title><?php echo $main_settings['ar_site_name'];?> | الحساب الشخصي</title>
            ...
            <form class="col s12" action="user-info.php" method="post">
              ...
              <div class="row">
                ...
                <div class="input-field col s12 center-align">
                  <input type="submit" name="update" value="تعديل" class="submit-button validate btn btn-float">
                </div>
            </form>
          </div>
        </div>
