...
?>
  ...
  <html>
    <head>
      ...
      <meta charset="utf-8">
      <title><?php echo $main_settings['ar_site_name'];?> | سلة الشراء</title>
    ...
    <body>
      ...
      <form action="cart.php" method="post">
        <div class="container">
                ...
                while($ids = @mysql_fetch_assoc($select_in_cart)){
                  ...
                  if($pro_info['value_of_discount'] == 0){
                    ...
                    header("Location: cart.php");
                      ...
                      error_message("أعلى عدد مسموح من المنتجات هو 9!");
                    }
                  }else{
                     if($quantity == 1){
                    $q = "update cart set quantity = ".$_POST['quantity'][$i]." where id = ".$ids['id'];
                    ...
                    header("Location: cart.php");
                      ...
                      error_message("هذا المنتج عليه خصم، الكمية يجب أن تكون 1 فقط!");
                    }
                  }
                }
                }
                ...
                while($ids = @mysql_fetch_assoc($select_in_cart)){
                  ...
                  if($pro_info['value_of_discount'] == 0){
                    ...
                    header("Location: cart.php");
                      ...
                      error_message("أعلى عدد مسموح به  من المنتجات هو 9!");
                    }
                  }else{
                     if($quantity == 1){
                    $q = "update cart set quantity = ".$_POST['quantity'][$i]." where id = ".$ids['id'];
                    ...
                    header("Location: cart.php");
                      ...
                      error_message("هذا المنتج عليه خصم، يجب أن تكون الكمية 1 فقط!");
                    }
                  }
                }
                }
              ...
              if($num_of_cart_info > 0){
                ...
                if(!empty($user_info['first_name']) and !empty($user_info['last_name']) and !empty($user_info['password']) and !empty($user_info['email']) and !empty($user_info['phone']) and !empty($user_info['address'])){
                  ...
                  if(isset($add_request)){
                    error_message("تم إرسال طلب الشراء إلى المدير بنجاح <br /> رقم الطلب الخاص بك هو: ".$req_num);
                  }
                }else{
                  error_message_with_link("بعض المعلومات الخاصة بك غير كاملة! يرجى إكمالها..","user-info.php");
                }
              }else{
                error_message("السلة فارغة!");
              }
            }else{
              error_message("يجب تسجيل الدخول إلى حسابك!");
            }
          }
          ...
          if($num_in_cart == 0){echo '<tr><td colspan="5"><b>لا يوجد منتجات في السلة.</b></td></tr>';}
          while($cart = @mysql_fetch_assoc($select_cart)){
            ...
            echo '
              <tr>
                <td><img src="../images/'.$product_in_cart['pic'].'" alt="'.$product_in_cart['ar_title'].'" width="100" class="responsive-img"></td>
                <td>'.$product_in_cart['ar_title'].'</td>
                <td>$'.$price.'</td>
                <td>
                ...
                <td><a href="cart.php?deletefromcart=ok&product_in_cart_id='.$product_in_cart['id'].'&item_id='.$cart['id'].'"><i class="fa fa-close" title="حذف"></i></a></td>
              </tr>
            ';
          ...
          <div class="cart_mobile hide-on-large-only">
            ...
            <?php
            $total1 = 0;
            if($num_in_cart1 == 0){echo '<div class="col l12 m12 s12 center-align"><b>لا يوجد منتجات في السلة.</b></div>';}
              ...
              <div class="col m6 s12">
                <div class="item">
                  <div class="container">
                    <div class="row">
                      <div class="col-sm-6">
                        <img src="../images/'.$product_in_cart1['pic'].'" alt="'.$product_in_cart1['ar_title'].'" class="responsive-img">
                      </div>
                      <div class="item-content">
                        <div class="row">
                            <div class="col s6">
                              <h6>'.$product_in_cart1['ar_title'].'</h6>
                            </div>
                            <div class="col s12">
                              <span>السعر: '.$price1.'</span>
                            </div>
                            <div class="col s12">
                              <div class="input-field">
                                ';
                    ...
                    echo '
                    الكمية: <input type="number" value="'.$cart1['quantity'].'" style="width: 50px;" min="1" max="'.$max_quantity1.'" name="quantity1['.$cart1['id'].']">
                    ';
                    }else{
                      echo "الكمية: ".$cart1['quantity'];
                    }
                    echo '
                              </div>
                            </div>
                            <div class="col m12 s12 center-align">
                              <a href="cart.php?deletefromcart=ok&product_in_cart_id='.$product_in_cart1['id'].'&item_id='.$cart1['id'].'" class="btn btn-float">حذف</a>
                            </div>
                          </div>
                      </div>
                    </div>
            ...
            <div class="row">
              ...
              <div class="col l12 m12 s12">
                <td class="center-align">
                  <br />
                  <h5>السعر الإجمالي: <?php echo $total;?>$</h5>
                </td>
              </div>
              <div class="col l4 m4 s12">
                <td class="center-align">
                  <br />
                  <input type="submit" class="btn btn-float" value="إرسال طلب الشراء" name="send_buy_request">
                </td>
              </div>
              <div class="col l4 m4 s12">
                <td>
                  <br />
                  <input type="submit" class="btn btn-float" value="إفراغ السلة" name="clear_cart">
                </td>
              </div>
              <div class="col l4 m4 s12">
                <td>
                  <br />
                  <input type="submit" class="btn btn-float" value="تعديل السلة" name="update_cart1">
                </td>
              </div>
          ...
          <div class="update-clear-cart hide-on-med-and-down">
            <div class="row">
              ...
              <div class="col l4 m4 s12">
                <td>
                  <br />
                  <input type="submit" class="btn btn-float" value="تعديل السلة" name="update_cart">
                </td>
              </div>
