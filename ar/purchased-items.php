...
?>
  ...
  <html>
    ...
    <body>
      ...
      <section class="purchased rtl">
        <div class="container">
          <div class="section-title center-align">
            <h1>المنتجات التي تم شرائها</h1>
          </div>
          <div class="row">
            <?php
            ...
            while($request_product = @mysql_fetch_assoc($select_request_product)){
              ...
              while($cart = @mysql_fetch_assoc($select_cart)){
                ...
                if($request_product['ok_from_admin'] == 'No') $ok_from_admin = "<span style='color: red;'>لا</span>"; else $ok_from_admin = "<span style='color: green;'>نعم</span>";
                echo '
             <div class="col l4 m6 s12">
              <div class="product">
                ...
                <div class="product-image">
                  <img src="../images/'.$product_info['pic'].'" alt="'.$product_info['ar_title'].'" class="responsive-img">
                </div>
                <div class="product-content">
                  <div class="product-name">
                    <h5>'.$product_info['ar_title'].'</h5>
                  </div>
                  <div class="quantity">
                    <p>الكمية: '.$cart['quantity'].'</p>
                  </div>
                  <div class="agree_from_admin">
                    <p>الموافقة من قبل المدير: '.$ok_from_admin.'</p>
                  </div>
