      ...
      <section class="about-us-page rtl">
        <div class="row">
          <div class="col l6 m12 hide-on-med-and-down">
            <div class="about-us">
              <div class="site_image">
                <img src="../images/<?php echo $about['pic'];?>" alt="<?php echo $about['ar_title'];?>" class="responsive-img">
              </div>
            </div>
          </div>
          <div class="col l6 m6 s12 hide-on-large-only center-align">
            <div class="about-us">
              <div class="site_image">
                <img src="../images/<?php echo $about['pic2'];?>" alt="<?php echo $about['ar_title'];?>" class="responsive-img">
              </div>
            </div>
          </div>
          <div class="col l6 m6 s12">
            <div class="about">
              <h2><?php echo $about['ar_title'];?></h2>
              <p>
                <?php echo $about['ar_description'];?>
              </p>
