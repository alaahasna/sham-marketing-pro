...
?>
  ...
  <html>
    <head>
      ...
      <meta charset="utf-8">
      <title><?php echo $main_settings['site_name'];?> | Services</title>
          ...
          <div class="row">
            <div class="col s12">
              <div class="service">
                <div class="row">
                  <div class="col l6 s12">
                    <img src="images/<?php echo $services['pic1'];?>" alt="<?php echo $services['title1'];?>" class="responsive-img">
                  </div>
                  <div class="col l6 s12">
                    <h2><?php echo $services['title1'];?></h2>
                    <p>
              ...
              <div class="service">
                <div class="row"> 
                  <div class="col l6 s12">
                    <h2><?php echo $services['title2'];?></h2>
                    <p>
                      <?php echo $services['description2'];?>
                    </p>
                  </div>
                  <div class="col l6 s12">
                    <img src="images/<?php echo $services['pic2'];?>" alt="<?php echo $services['title2'];?>" class="responsive-img">
                  </div>
                </div>
              </div>
            </div>
