      ...
      <section class="cart">
        <div class="container">
          ...
          if(isset($_GET['product_in_cart_id']) and isset($_GET['item_id'])){
            ...
            $delete_from_cart = @mysql_query("delete from cart where product_id='".$product_in_cart_id."' and session_id='".$session_id."'") or die(mysql_error());
              ...
              if($num_of_cart_info > 0){
                ...
                if(!empty($user_info['first_name']) and !empty($user_info['last_name']) and !empty($user_info['password']) and !empty($user_info['email']) and !empty($user_info['phone']) and !empty($user_info['address'])){
                  ...
                  if(isset($add_request)){
                    error_message("Buy Request has been sent to admin successfly.");
                  }
                }else{
              ...
              <tr>
                ...
                <td>
                  <div class="input-field">
                    <!--<input type="number" value="'.$cart['quantity'].'" name="countity">-->
                    '.$cart['quantity'].'
                  </div>
                </td>
                      ...
                      <div class="item-content">
                        <div class="row">
                            ...
                            <div class="col m12 s12 center-align">
                              <a href="cart.php?deletefromcart=ok&product_in_cart_id='.$product_in_cart1['id'].'&item_id='.$cart['id'].'" class="btn btn-float">Delete Item</a>
                            </div>
                          </div>
                      </div>
                    </div>
